...
class HelpView(discord.ui.View):
    ...
    async def music_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title=get_lan(interaction, "help_music_title"),
            description=get_lan(interaction, "help_music_description"),
            color=THEME_COLOR,
        )
    ...
    async def general_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title=get_lan(interaction, "help_general_title"),
            description=get_lan(interaction, "help_general_description"),
            color=THEME_COLOR,
        )
        embed.set_image(url=APP_BANNER_URL)
...
class BackToMainView(discord.ui.View):
    ...
    async def home_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title=get_lan(interaction, "help_main_title"),
            description=get_lan(interaction, "help_main_description"),
            color=THEME_COLOR,
        )
        embed.set_image(url=APP_BANNER_URL)
